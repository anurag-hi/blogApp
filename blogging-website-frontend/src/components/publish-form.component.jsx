...
const PublishForm = () =>{
    ...
    const handleBlogDesChange = (e)=>{
        let input = e.target;
        // console.log({blog, des: input.value});
    ...
    const publishBlog =(e)=>{
        ...
        //Disable submission multiple times
        ...
        .then(()=>{
            ...
            //Redirect to homepaage after publishing
            setTimeout(()=>{
                navigate("/")
            }, 500);
        })
        ...
        <AnimationWrapper>
            <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4">
                ...
                <div className="border-grey lg:border-1 lg:pl-8">
                    ...
                    <input type="text" placeholder="Blog Title" defaultValue={title} className="input-box pl-4" onChange={handleBlogTitleChange}></input>
                    ...
                    <p>Topics - (Helps in searching and ranking your blog.)</p>
